...
<span onclick="openNav()"> <button class="btnmenu"><i class="fa fa-bars"></i></button> </span>
    ...
    <div id="main">
      <form class="update-form" action="../controller/getlist-view.php" method="post">
        <h1>Find Record</h1>
        <div class="txtb">
          <input type="text" name="name" id="txtName" value="" placeholder="Name (Leave Blank to get all records)">
        </div>
